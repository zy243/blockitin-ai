...
const Dashboard: React.FC = () => {
  ...
  const recentActivity = [
    { id: 'dashboard-activity-1', type: 'credential', title: 'Computer Science Degree NFT Minted', time: '2 hours ago' },
    { id: 'dashboard-activity-2', type: 'health', title: 'COVID-19 Vaccination Record Uploaded', time: '1 day ago' },
    { id: 'dashboard-activity-3', type: 'attendance', title: 'Attended Advanced AI Lecture', time: '2 days ago' },
    { id: 'dashboard-activity-4', type: 'publish', title: 'Research Paper Published', time: '1 week ago' },
  ]
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          {recentActivity.map((activity) => (
            <div key={activity.id} id={activity.id} className="flex items-start space-x-4 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
